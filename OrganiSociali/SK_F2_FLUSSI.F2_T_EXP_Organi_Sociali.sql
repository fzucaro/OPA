...
/****** Object:  Table [SK_F2_FLUSSI].[F2_T_EXP_OrganiSociali]    Script Date: 07/12/2017 15:48:06 ******/
SET ANSI_NULLS ON
GO
...
IF (EXISTS (SELECT * 
                 ...
                 AND  TABLE_NAME = 'F2_T_EXP_OrganiSociali'))
BEGIN
    DROP  TABLE SK_F2_FLUSSI.F2_T_EXP_OrganiSociali
END
-- ************************************************************************************************************************
CREATE TABLE [SK_F2_FLUSSI].[F2_T_EXP_OrganiSociali](
	
	[Data_estrazione] [date] NOT NULL,
	[Destinatario] [nvarchar](5),
