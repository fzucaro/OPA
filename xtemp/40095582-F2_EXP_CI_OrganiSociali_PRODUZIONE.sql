...
/****** Object:  StoredProcedure [SK_F2_FLUSSI].[F2_EXP_CI_OrganiSociali]    Script Date: 2/26/2018 3:14:34 PM ******/
SET ANSI_NULLS ON
GO

SET QUOTED_IDENTIFIER ON
GO
--DROP PROCEDURE [SK_F2_FLUSSI].[F2_EXP_CI_OrganiSociali]
GO
CREATE PROCEDURE [SK_F2_FLUSSI].[F2_EXP_CI_OrganiSociali]
...
BEGIN
  ...
  BEGIN
      ...
      DELETE FROM SK_F2_FLUSSI.F2_T_EXP_CI_OrganiSociali
      ...
      BEGIN    
        ...
        DECLARE Esponenti_CUR CURSOR FOR
         SELECT esp.ID_Persona_Fisica, ISNULL(esp.ID_Societa_Gruppo,0), org.ID_Organo, inc.ID_Incarico
           FROM SK_F2.F2_T_Organi_Societa org, SK_F2.F2_T_Incarichi_Societa inc,
                SK_F2.F2_T_Esponenti esp 
        ...
        BEGIN 
            ...
            INSERT INTO SK_F2_FLUSSI.F2_T_EXP_CI_OrganiSociali (
               Data_estrazione
              ,ABI_Segnalante
              ,SNDG_Partecipata
              ,Codice_Istituto
      ...
      -- Gestione scarti
      UPDATE SK_F2_FLUSSI.F2_T_EXP_CI_OrganiSociali
         SET Flag_Scarto = 1,
