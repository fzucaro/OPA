...
/****** Object:  Table [SK_F2_FLUSSI].[F2_T_EXP_@NOME_TABELLA@]    Script Date: 07/12/2017 15:48:06 ******/
SET ANSI_NULLS ON
GO
...
IF (EXISTS (SELECT * 
                 ...
                 AND  TABLE_NAME = 'F2_T_EXP_@NOME_TABELLA@'))
BEGIN
    DROP  TABLE SK_F2_FLUSSI.F2_T_EXP_@NOME_TABELLA@
END
-- ************************************************************************************************************************
CREATE TABLE [SK_F2_FLUSSI].[F2_T_EXP_@NOME_TABELLA@](
